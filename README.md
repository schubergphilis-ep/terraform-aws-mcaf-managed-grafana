...
| <a name="input_policy"></a> [policy](#input\_policy) | Additional Policy document to attach to the workspace IAM role. This is only valid when permission\_type is set to CUSTOMER\_MANAGED and no IAM role is specified. | `string` | `null` | no |
